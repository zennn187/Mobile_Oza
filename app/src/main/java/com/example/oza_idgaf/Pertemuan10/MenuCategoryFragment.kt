...
class MenuCategoryFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        // MENERAPKAN MODE GRID VERTIKAL DENGAN 2 KOLOM
        recyclerView.layoutManager =
            GridLayoutManager(requireContext(), 2) // <--- KUNCI UTAMANYA DI SINI

        // Dummy Data & filter (tetap sama, cuma data gambar-nya diubah jadi URL)
